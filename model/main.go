...
func migrateDBFast() error {
	...
	migrations := []struct {
		...
		{&TopUp{}, "TopUp"},
		{&AffiliateRewardEvent{}, "AffiliateRewardEvent"},
		{&QuotaData{}, "QuotaData"},
		{&Task{}, "Task"},
		{&Model{}, "Model"},
		{&Vendor{}, "Vendor"},
		...
		{&PlaygroundImageBatch{}, "PlaygroundImageBatch"},
...
` + "`applicable_group`" + ` varchar(64) DEFAULT '',
...
PRIMARY KEY (` + "`id`" + `)
	...
	required := []sqliteColumnDef{
		...
		{Name: "applicable_group", DDL: "`applicable_group` varchar(64) DEFAULT ''"},
