...
// GetEnabledAbilitiesWithChannelsByGroups is the narrow read model used by
// Playground capability discovery. It joins the actual channel mapping so a
// public model name can be resolved to the upstream image model before its
