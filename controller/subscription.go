...
func AdminCreateSubscriptionPlan(c *gin.Context) {
	...
	req.Plan.ApplicableGroup = model.NormalizeSubscriptionApplicableGroup(req.Plan.ApplicableGroup)
	if req.Plan.ApplicableGroup != "" {
		if _, ok := ratio_setting.GetGroupRatioCopy()[req.Plan.ApplicableGroup]; !ok {
