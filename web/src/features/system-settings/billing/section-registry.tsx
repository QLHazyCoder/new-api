...
const getGroupDefaults = (settings: BillingSettings) => ({
  ...
  GroupDescriptions: settings['group_ratio_setting.group_descriptions'],
    ...
    build: (settings: BillingSettings) => (
      <QuotaSettingsSection
        defaultValues={{
          ...
          TopUpInviteRewardPercent: settings.TopUpInviteRewardPercent,
      ...
      <PaymentSettingsSection
        defaultValues={{
          ...
          AmountDiscountEligibleGroups:
            settings['payment_setting.amount_discount_eligible_groups'],
